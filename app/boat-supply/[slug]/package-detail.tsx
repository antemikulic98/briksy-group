                ...
                <div className="px-4 pt-3 sm:px-6 sm:pt-4">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-border bg-slate-50 py-2.5 pl-10 pr-4 text-sm focus:border-accent focus:bg-white focus:ring-2 focus:ring-accent/20 focus:outline-none"
                    />
                    {catalogSearch && (
                      <button
                        onClick={() => setCatalogSearch("")}
                        className="absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer rounded-full p-0.5 text-muted hover:text-foreground"
                      >
                ...
                <div className="divide-y divide-border sm:grid sm:grid-cols-2 sm:gap-2 sm:divide-y-0 sm:p-4 lg:grid-cols-3">
                  ...
                  {catalogProducts.length === 0 && (
                    <p className="col-span-full py-8 text-center text-sm text-muted sm:py-6">
                      {catalogSearch
                        ? `No products found for "${catalogSearch}"`
        ...
        <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-border bg-white/95 backdrop-blur-sm pb-[env(safe-area-inset-bottom)]">
          <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6 sm:py-3.5">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <a
                href="https://wa.me/385919255000"
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#25D366] text-white shadow-lg shadow-[#25D366]/20 transition-all active:scale-[0.97] hover:bg-[#1fb855] sm:h-11 sm:w-11"
